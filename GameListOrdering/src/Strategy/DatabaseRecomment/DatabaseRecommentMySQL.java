...
public class DatabaseRecommentMySQL implements DatabaseRecommentStrategy{
    ...
    public int addGameIDEvenExist(String gameID) throws Exception {
        ...
        try {
            ...
            preparedStatement.setString(1,DBString.pointOfGameTableString);
            preparedStatement.setString(2,DBString.gameIDString);
    ...
    public int update(List<String> listGame) throws Exception, SQLException {
        ...
        try {
            ...
            for(int i=0;i<listGame.size();i++){
                ...
                preparedStatment.setString(1, DBString.pointOfGameTableString);
                preparedStatment.setString(2, DBString.pointString);
                preparedStatment.setString(3, DBString.pointString);
                preparedStatment.setLong(4, point);
                preparedStatment.setString(5, DBString.gameIDString);
