 ...
 * @author root
 */
public class ThreadClientPool<T extends TServiceClient> implements AutoCloseable {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ThreadClientPool.class);

    private final GenericObjectPool<T> internalPool;

    public ThreadClientPool(ClientFactory<T> clientFactory,
