...
public class ThriftConnectionPoolConfig {
     ...
     * Transport type
     */
    private TTransportType thriftTransport;
    /**
     * 连接超时时间
     */
    ...
    public TTransportType getThriftTransport() {
        return thriftTransport;
    }

    public void setThriftTransport(TTransportType thriftTransport) {
     ...
     * 检查配置信息的方法
     *
     * @throws ThriftConnectionPoolException 当配置信息出现问题时抛出该异常
     */
